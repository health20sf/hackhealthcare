...
CREATE TABLE `users` (
  ...
  `email_address` char(80) COLLATE utf8_unicode_ci DEFAULT NULL,
  PRIMARY KEY (`id`)
...
INSERT INTO `users` VALUES (1,'crow','Crow','T','Robot'),(2,'servo','Tom','','Servo'),(3,'ryder','Gristle','','McThornbody'),(4,'gomrpickles','Evan','','Pickett');
